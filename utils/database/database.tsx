...
const connectToDatabse = async () => {
    ...
    try{
        await db.execAsync(`
            ...
            CREATE TABLE IF NOT EXISTS product (id_product INTEGER PRIMARY KEY NOT NULL, id_conditionnement TEXT NOT NULL, id_inventory INTEGER NOT NULL, name TEXT NOT NULL, conditionment TEXT NOT NULL, quantity REAL NOT NULL DEFAULT(0));
